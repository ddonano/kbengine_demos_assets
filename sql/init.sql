...
INSERT INTO `t_space_config` (`code`, `type`, `name`, `location`, `tip`, `desc`, `pic`, `url`, `status`, `del_flag`, `create_by`, `update_by`, `create_time`, `update_time`, `module_id`, `spawn_pos`, `create_status`, `space_id`, `partition_size`, `sort`) VALUES ('kbengine_unity3d_demo', '1', '中央广场测试', '0,0,0', NULL, NULL, '/picture/2023/03/22/1d0e48fd-9e57-4925-b4e7-0fc5bed262fa.png', NULL, '1', '2', NULL, 'admin', NULL, '2023-03-22 20:09:07', '0', '0,1,0', '1', '14', '100', '2');
